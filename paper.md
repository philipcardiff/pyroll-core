...
Groove rolling is one of the main process routes for producing long metal products, such as bars, beams, wires and rods.
In this process, a workpiece is deformed by two or more rotating rolls to reduce the cross-section and achieve the desired cross-section shape.
...
They are used to estimate forces and engine torques, as well as the geometrical and microstructural evolution of the workpiece for a given pass sequence and input workpiece geometry and material.
...
Established in the late 19th century, mathematical modelling of groove rolling and optimization of grooves, known as groove or roll pass design, was investigated by various authors.
...
To make optimum use of these models, attempts to automatic groove pass design was always an issue of development [@Kunzman1977; @Koermer1987; @Hensel1987; @Hensel1987a; @Hensel1988; @Schmidt1997; @Malmgren2000; @Eriksson2004; @Eriksson2004a; @Eriksson2005; @Betshammer2006; @Krause2007; @Lambiase2009; @Alexey2015; @Schmidtchen2020; @Schmidtchen2021; @Overhagen2020; @Overhagen2020a; @Overhagen2021a].
...
The main disadvantage is the high computational effort in solving the equation systems, increasing rapidly with the nonlinearity of the model equations and the resolution of the solution space, typically in the range from hours to days.
Analytical and empirical models, however, do not provide such high accuracy and depth but are usually computable within fractions of seconds.
So, they are suitable for interactive design with quick feedback loops and numerical applications, which require many evaluations, such as optimization routines.
...
Notable exceptions from this are @Alexander1972 and a textbook by @Pawelski2000.
Also, the field is characterized by using handcrafted, specialized and not reusable self-made tools or using large commercial FEM packages, either specialized or general-purpose.
...
The primary focus lies hereby on analytical, empirical and semi-empirical approaches, although interfacing with third-party software such as FEM or CALPHAD suites, as well as material databases, is possible and planned.
PyRolL is deeply integrated with Python's scientific ecosystem, which allows efficient and user-friendly post-processing of simulation results, as well as the application of numerical routines wrapped around the simulation core, such as optimization and fitting of metamodels.
